...
const Menu: React.FC<SidebarProps> = ({ isOpen, toggleSidebar, isAuthenticated }) => {
      ...
      <Nav defaultActiveKey="/home" className="flex-column">
        {!isAuthenticated ? (
          ...
          <>
            ...
            {isOpen ? (
              <div className="nav-link text-white fw-bold text-custom-color d-flex align-items-center" onClick={togglePlanSubmenu}>
              ...
              <OverlayTrigger placement="right" overlay={renderTooltip("Planificación")}>
                <div className="nav-link text-white text-custom-color d-flex align-items-center" onClick={togglePlanSubmenu}>
                  <i className="fa-solid fa-business-time"></i>
                </div>
              </OverlayTrigger>
            )}
            ...
            {isPlanOpen && (
              <div className="submenu">
                {isOpen ? (
                  <NavLink to="/planificacion/planificacion" className="nav-link text-white d-flex align-items-center">
                ...
                {isOpen ? (
                  <NavLink to="/planificacion/actividades" className="nav-link text-white d-flex align-items-center">
            ...
            {isOpen ? (
              <div className="nav-link text-white text-custom-color fw-bold d-flex align-items-center" onClick={toggleVerificacionSubmenu}>
                <i className="fa-solid fa-circle-check"></i>
                <span>Verificación</span>
                <i className={`ms-auto ${isVerificacionOpen ? "fa-solid fa-chevron-up" : "fa-solid fa-chevron-down"}`}></i>
              </div>
            ) : (
              <OverlayTrigger placement="right" overlay={renderTooltip("Verificación")}>
                <div className="nav-link text-white text-custom-color d-flex align-items-center" onClick={toggleVerificacionSubmenu}>
                  <i className="fa-solid fa-circle-check"></i>
                </div>
              </OverlayTrigger>
            )}
            ...
            {isVerificacionOpen && (
              <div className="submenu">
                {isOpen ? (
                  <NavLink to="/verificacion/verificadores-de-control" className="nav-link text-white d-flex align-items-center">
                    <i className="fa-solid fa-list-check"></i>
                    <span>Verificadores de Control</span>
                  </NavLink>
                ) : (
                  <OverlayTrigger placement="right" overlay={renderTooltip("Verificadores de Control")}>
                    <NavLink to="/verificacion/verificadores-de-control" className="nav-link text-white d-flex align-items-center">
                      <i className="fa-solid fa-list-check"></i>
                    </NavLink>
                  </OverlayTrigger>
                ...
                {isOpen ? (
                  <NavLink to="/verificacion/items" className="nav-link text-white d-flex align-items-center">
            ...
            {isOpen ? (
              <div className="nav-link text-white text-custom-color fw-bold d-flex align-items-center" onClick={toggleMatrizSubmenu}>
              ...
              <OverlayTrigger placement="right" overlay={renderTooltip("Matriz de Peligro")}>
                <div className="nav-link text-white text-custom-color d-flex align-items-center" onClick={toggleMatrizSubmenu}>
                  <i className="fa-solid fa-triangle-exclamation"></i>
                </div>
              </OverlayTrigger>
            )}
            ...
            {isMatrizOpen && (
              <div className="submenu">
                ...
                {isOpen ? (
                  <div className="nav-link text-white text-custom-color fw-bold d-flex align-items-center" onClick={toggleConfiguracionMatrizSubmenu}>
                    <i className="fa-solid fa-gear"></i>
                    <span>Configuración</span>
                    <i className={`ms-auto ${isConfiguracionMatrizOpen ? "fa-solid fa-chevron-up" : "fa-solid fa-chevron-down"}`}></i>
                  </div>
                ) : (
                  <OverlayTrigger placement="right" overlay={renderTooltip("Configuración de Matriz")}>
                    <div className="nav-link text-white d-flex align-items-center" onClick={toggleConfiguracionMatrizSubmenu}>
                      <i className="fa-solid fa-gear"></i>
                    </div>
                  </OverlayTrigger>
                )}
                ...
                {isConfiguracionMatrizOpen && (
                  <div className="submenu">
                    {isOpen ? (
                      <NavLink to="/matriz-de-peligro/configuracion/tareas" className="nav-link text-white d-flex align-items-center">
                    ...
                    {isOpen ? (
                      <NavLink to="/matriz-de-peligro/configuracion/tipo-de-tareas" className="nav-link text-white d-flex align-items-center">
                        <i className="fa-solid fa-list-check"></i>
                        <span>Tipo de Tareas</span>
                      </NavLink>
                    ) : (
                      <OverlayTrigger placement="right" overlay={renderTooltip("Tipo de Tareas")}>
                        <NavLink to="/matriz-de-peligro/configuracion/tipo-de-tareas" className="nav-link text-white d-flex align-items-center">
                          <i className="fa-solid fa-list-check"></i>
                        </NavLink>
                      </OverlayTrigger>
                    ...
                    {isOpen ? (
                      <NavLink to="/matriz-de-peligro/configuracion/jerarquia-de-control" className="nav-link text-white d-flex align-items-center">
                        <i className="fa-solid fa-network-wired"></i>
                        <span>Jerarquía de Control</span>
                      </NavLink>
                    ) : (
                      <OverlayTrigger placement="right" overlay={renderTooltip("Jerarquía de Control")}>
                        <NavLink to="/matriz-de-peligro/configuracion/jerarquia-de-control" className="nav-link text-white d-flex align-items-center">
                          <i className="fa-solid fa-network-wired"></i>
                        </NavLink>
                      </OverlayTrigger>
                    ...
                    {isOpen ? (
                      <NavLink to="/matriz-de-peligro/configuracion/peligro" className="nav-link text-white d-flex align-items-center">
                        <i className="fa-solid fa-circle-radiation"></i>
                        <span>Peligros</span>
                      </NavLink>
                    ) : (
                      <OverlayTrigger placement="right" overlay={renderTooltip("Peligros")}>
                        <NavLink to="/matriz-de-peligro/configuracion/peligro" className="nav-link text-white d-flex align-items-center">
                          <i className="fa-solid fa-circle-radiation"></i>
                        </NavLink>
                      </OverlayTrigger>
                    ...
                    {isOpen ? (
                      <NavLink to="/matriz-de-peligro/configuracion/riesgos" className="nav-link text-white d-flex align-items-center">
            ...
            {isOpen ? (
              ...
              <OverlayTrigger placement="right" overlay={renderTooltip("Organización")}>
                <div className="nav-link text-white text-custom-color d-flex align-items-center" onClick={toggleOrgSubmenu}>
                  <i className="fa-solid fa-layer-group"></i>
                </div>
              </OverlayTrigger>
            )}
            ...
            {isOrgOpen && (
              <div className="submenu">
                ...
                {isOpen ? (
                  <NavLink to="/organizacion/compañias" className="nav-link text-white d-flex align-items-center">
                    <i className="fa-solid fa-building"></i>
                    <span>Compañías</span>
                  </NavLink>
                ) : (
                  <OverlayTrigger placement="right" overlay={renderTooltip("Compañías")}>
                    <NavLink to="/organizacion/compañias" className="nav-link text-white d-flex align-items-center">
                      <i className="fa-solid fa-building"></i>
                    </NavLink>
                  </OverlayTrigger>
                ...
                {isOpen ? (
                  <NavLink to="/organizacion/areas" className="nav-link text-white d-flex align-items-center">
                ...
                {isOpen ? (
                  <NavLink to="/organizacion/colaboradores" className="nav-link text-white d-flex align-items-center">
                ...
                {isOpen ? (
                  <NavLink to="/organizacion/cargos" className="nav-link text-white d-flex align-items-center">
