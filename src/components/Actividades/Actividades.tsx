...
//               hazzardId: hazard.hazzardId ? String(hazard.hazzardId) : "",
//               criticityId: hazard.criticityId ? String(hazard.criticityId) : "",
...
//     // Convert hazzardId and criticityId to numbers before sending
//     const hazzards = hazzardCriticityPairs.map((pair) => ({
//       hazzardId: Number(pair.hazzardId),
//       criticityId: Number(pair.criticityId),
//     }));
...
//       if (method === "POST") {
// 		console.log(".....pruebaa.....", newActividad)
...
//                                 const hazzard =
//                                   hazzards.find((hz) => (act.id) === hz.id)?.name ||
//                                   console.log("*****CRI****", criticities)
// 								  console.log("*****HAZZ****", hazzards)
//                                 const criticity =
// 								criticities.find((cr) => String(hz.description) === cr.description)
//                                 const criticityText = criticity
//                                   ? `${criticity.name} - ${criticity.description}`
//                                   : "Información de criticidad no disponible";

//                                 return (
//                                   <li key={`${hz.hazzardId}-${hz.criticityId}-${index}`}>
