...
function Tareas() {
	...
	const getTasksType = async () => {
		try {
		  const response = await axios.get<TaskType[]>('https://asymetricsbackend.uk.r.appspot.com/task_type');
...
// 							</div>
// 							<div className="mb-3">
// 								<label htmlFor="tastType" className="form-label">Tipo de Tarea</label>
// 								<select
// 									id="criticityType"
// 									className="form-select"
// 									value={selectedTaskTypeId}
...
// 									{taskType.map(ts => (
// 									<option key={ts.id} value={ts.id}>{ts.description + ' - ' + ts.name}</option>
// 									))}
// 								</select>
//                 			</div>
// 							<div className="modal-body">
