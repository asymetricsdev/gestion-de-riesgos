...
//       // Eliminar primero los subordinados del cargo si los tiene
//       if (position.subordinatePositions.length > 0) {
//         for (let subordinate of position.subordinatePositions) {
//           await axios.delete(`${baseURL}/position/${subordinate.id}`, {
//             headers: { "Content-Type": "application/json" },
//           });
//         }
//       }
  
//       // Eliminar el cargo una vez que se han eliminado sus subordinados
//       await axios.delete(`${baseURL}/position/${id}`, {
//         headers: { "Content-Type": "application/json" },
//       });
...
const Position: React.FC = () => {
  ...
  const validar = (): void => {
    ...
    const openModal = (position: PositionData | null) => {
