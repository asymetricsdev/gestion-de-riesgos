...
import Usuarios from '../Pages/UsuarioPage';
  ...
  return (
		<Routes>
			...
			<Route
				path="/planificacion"
				element={
					<PrivateRoute isAuthenticated={isAuthenticated} component={<PlanificadorActividad />} />
				}
			/>
			<Route
			...
			<Route
				...
				element={
					<PrivateRoute isAuthenticated={isAuthenticated} component={<VerificadorControl />} />
				}
			/>
			<Route
			...
			<Route
				...
				element={
					<PrivateRoute isAuthenticated={isAuthenticated} component={<JerarquiaControl />} />
				}
			/>
			<Route
			...
			<Route
				path="/usuarios"
				element={<PrivateRoute isAuthenticated={isAuthenticated} component={<Usuarios />} />}
			/>
			<Route
				path="/roles"
			...
			<Route
				...
				element={
					<PrivateRoute isAuthenticated={isAuthenticated} component={<TareaColaborador />} />
				}
			/>
			<Route
				...
				element={
					<PrivateRoute
						...
						component={<ColaboradorEjecutarTarea />}
					/>
				}
			/>
